...
dist = 0:10:120; % Distancias L (m) del usuario
...
for freq_idx = 1:length(frequencies)
    ...
    for a=1:length(dist) 
       [Dis_BStoRIS, Dis_BStoUser, Dis_RIStoUser]=Position_generate_RIS4080(B,R,K,dist(a));
...
sgtitle('Rendimiento RIS vs. sin RIS para distintas frecuencias con RIS en 40 y 80', 'FontSize', 14, 'FontWeight', 'bold');
