function [W,Theta,R_sum]=MyAlgorithm_2bit(B,BS_antennas,User_antennas,P_max,K,P,R,N_ris,sigma2,H_bkp,F_rkp,G_brp,W,Theta)
iteration=30;  %迭代次数
...
Theta_all=[0,pi/2,pi,3*pi/2,2*pi];
