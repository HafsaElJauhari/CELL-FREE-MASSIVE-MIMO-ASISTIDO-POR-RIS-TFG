%% Script para dibujar resultados de selección vs no selección (2 usuarios)
clear; close all;
...
xlabel('Distancia del usuario 1, $d$ (m)', 'Interpreter', 'latex', 'FontSize', 14);
...
savefig('figura_3p5GHz_2usuarios.fig');
print('figura_3p5GHz_2usuarios', '-dpng', '-r300');
print('figura_3p5GHz_2usuarios', '-djpeg', '-r300');
...
savefig('figura_8GHz_2usuarios.fig');
print('figura_8GHz_2usuarios', '-dpng', '-r300');
print('figura_8GHz_2usuarios', '-djpeg', '-r300');
...
savefig('figura_15GHz_2usuarios.fig');
print('figura_15GHz_2usuarios', '-dpng', '-r300');
print('figura_15GHz_2usuarios', '-djpeg', '-r300');
...
savefig('comparacion_frecuencias_2usuarios.fig');
print('comparacion_frecuencias_2usuarios', '-dpng', '-r300');
print('comparacion_frecuencias_2usuarios', '-djpeg', '-r300');
...
fprintf('\n=== Figuras guardadas ===\n');
fprintf('- figura_3p5GHz_2usuarios.fig / .png / .jpg\n');
fprintf('- figura_8GHz_2usuarios.fig / .png / .jpg\n');
fprintf('- figura_15GHz_2usuarios.fig / .png / .jpg\n');
fprintf('- comparacion_frecuencias_2usuarios.fig / .png / .jpg\n');
