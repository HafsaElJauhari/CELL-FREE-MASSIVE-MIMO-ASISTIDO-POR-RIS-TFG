% Simulación 3.5 GHz - Selección GREEDY
...
for a = 1:length(dist)
    ...
    for b = 1:Iteration
        ...
        [~,~,R_sum_sel,R_k_sel] = MyAlgorithm_sel_greedy(B,BS_antennas,User_antennas,P_max,K,P,R,N_ris,sigma2,H_bkp,F_rkp,G_brp,W_init,Theta_init);
...
toc
save('resultados_3_5GHz_greedy.mat');
