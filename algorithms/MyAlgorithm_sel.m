function [W_sel,Theta_sel,R_sum_sel,R_k]=MyAlgorithm_sel(B,BS_antennas,User_antennas,P_max,K,P,R,N_ris,sigma2,H_bkp,F_rkp,G_brp,W,Theta)
    [~,F_rkp_sel,Theta_sel]=RISselection(B,BS_antennas,User_antennas,K,P,R,N_ris,sigma2,H_bkp,F_rkp,G_brp,W,Theta);
    [W_sel,Theta_sel,~,~]=MyAlgorithm(B,BS_antennas,User_antennas,P_max,K,P,R,N_ris,sigma2,H_bkp,F_rkp_sel,G_brp,W,Theta_sel); 
    
%    [W_sel,Theta_sel,~]=MyAlgorithm_LCR(B,BS_antennas,User_antennas,P_max,K,P,R,N_ris,sigma2,H_bkp,F_rkp,G_brp,W,Theta,Rmatch);
